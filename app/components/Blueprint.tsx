...
const Blueprint = () => {
  return (
    <section className="relative bg-black flex flex-col items-center overflow-hidden py-24 px-4 sm:px-6">
      ...
      <h2 className="text-white text-center font-normal leading-snug max-w-md mx-auto mb-20 md:text-3xl text-xl">
        ...
        {steps.map((step, i) => (
          <div key={i} className="relative flex gap-0 mb-12 last:mb-0">
            ...
            <div className="flex flex-col gap-3 pl-8">
              ...
              <p className="text-white/75 text-sm leading-relaxed max-w-50">
                {step.text}
              </p>
            </div>
          </div>
